  ...
  return (
    <div className={classes.root}>
      ...
      <p>
        ...
        Privacy Policy is maintained by the{' '}
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Truth or Dare.
          </p>
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Truth or Dare, accessible from tord.netlify.com
        </li>
        <li>
